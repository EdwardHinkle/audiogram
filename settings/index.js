...
module.exports = {
  ...
  fonts: [
    ...
    { family: "HelveticaNeueMedium", file: path.join(__dirname, "fonts", "HelveticaNeueMedium.ttf")  },
    { family: "HelveticaNeueBold", file: path.join(__dirname, "fonts", "HelveticaNeueBold.ttf") },
